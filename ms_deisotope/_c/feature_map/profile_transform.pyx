...
def skewed_gaussian_shape(np.ndarray[np.float64_t, ndim=1] xs, double center,
...
@cython.boundscheck(False)
@cython.cdivision(True)
def bigaussian_shape(np.ndarray[np.float64_t, ndim=1] xs, double center,
...
@cython.boundscheck(False)
@cython.cdivision(True)
def gaussian_shape(np.ndarray[np.float64_t, ndim=1] xs, double center,
