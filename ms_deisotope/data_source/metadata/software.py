...
software_names = [
    ...
    SoftwareName(u'MassHunter Easy Access', u'MS:1000679', u'Software for open access data acquisition.',
                 'software', [u'Agilent software', u'acquisition software', u'software']),
    SoftwareName(u'GPS Explorer', u'MS:1000661', u'SCIEX or Applied Biosystems software for data acquisition and analysis.',
    ...
    SoftwareName(u'MALDI Solutions', u'MS:1001558', u'Shimadzu Biotech software for data acquisition, processing, and analysis.',       'software', [
                 u'acquisition software', u'analysis software', u'data processing software', u'Shimadzu Corporation software', u'software']),
    SoftwareName(u'Lipid-Pro', u'MS:1002972', u'A computational lipid identification solution for untargeted lipidomics on data-independent acquisition tandem mass spectrometry platforms.',
                 'software', [u'lipidomics analysis software', u'data processing software', u'small molecule analysis software', u'software', u'analysis software']),
    ...
    SoftwareName(u'BioTools', u'MS:1000707', u'Bruker software for data analysis.',       'software', [
                 u'Bruker software', u'analysis software', u'data processing software', u'software']),
    SoftwareName(u'LipidMatch', u'MS:1002969', u'An automated workflow for rule-based lipid identification using untargeted high-resolution tandem mass spectrometry data.',
                 'software', [u'lipidomics analysis software', u'data processing software', u'small molecule analysis software', u'software', u'analysis software']),
    ...
    SoftwareName(u'Compass', u'MS:1000712', u'Bruker Compass software.',       'software', [
                 u'Bruker software', u'analysis software', u'data processing software', u'software']),
    SoftwareName(u'ALEX123', u'MS:1002977', u'Analysis of lipid experiments 123, a calculator with m/z values of intact lipid molecules (MS1) and their fragment ions at the MS2 and MS3 level.',
                 'software', [u'lipidomics analysis software', u'data processing software', u'small molecule analysis software', u'software', u'analysis software']),
    SoftwareName(u'ALEX', u'MS:1002976', u'Analysis of lipid experiments, a calculator for m/z values of intact lipid molecules (MS1).',       'software',
    ...
    SoftwareName(u'LipidFinder', u'MS:1002973', u'A computational workflow for the discovery of lipids for the identification of eicosanoid-phosphoinositides in platelets.',
                 'software', [u'lipidomics analysis software', u'data processing software', u'small molecule analysis software', u'software', u'analysis software']),
    SoftwareName(u'LipidBlast', u'MS:1002971', u'LC-MS-based lipidomics and automated identification of lipids using the LipidBlast in-silico MS/MS library.',
                 'software', [u'lipidomics analysis software', u'data processing software', u'small molecule analysis software', u'software', u'analysis software']),
    SoftwareName(u'Greazy', u'MS:1002970', u'Open-source software for automated phospholipid tandem mass spectrometry identification.',       'software',
                 [u'lipidomics analysis software', u'data processing software', u'small molecule analysis software', u'software', u'analysis software']),
    SoftwareName(u'LipidQA', u'MS:1002980', u'Lipid qualitative/quantitative analysis software for identification and quantitation of complex lipid molecular species.',
                 'software', [u'lipidomics analysis software', u'data processing software', u'small molecule analysis software', u'software', u'analysis software']),
    ...
    SoftwareName(u'QuantAnalysis', u'MS:1000736', u'Bruker software for data analysis.',       'software', [
                 u'Bruker software', u'analysis software', u'data processing software', u'software']),
    SoftwareName(u'LipidXplorer', u'MS:1002968', u'Software for consensual cross-platform lipidomics.',       'software',
                 [u'lipidomics analysis software', u'data processing software', u'small molecule analysis software', u'software', u'analysis software']),
    SoftwareName(u'MzWiff', u'MS:1000591', u'A software program for converting Applied Biosystems wiff file format to the mzXML or mzML format. MzWiff is currently maintained at the Institute for Systems Biology. It replaces the slower mzStar program.',
                 'software', [u'data processing software', u'software']),
    SoftwareName(u'LipidHunter', u'MS:1002967', u'Software for identification of phospholipids by high-throughput processing of LC-MS and shotgun lipidomics datasets.',
                 'software', [u'lipidomics analysis software', u'data processing software', u'small molecule analysis software', u'software', u'analysis software']),
    SoftwareName(u'Lipid Data Analyzer', u'MS:1002965', u'Lipid Data Analyzer software for lipid quantification.',       'software', [
                 u'lipidomics analysis software', u'data processing software', u'small molecule analysis software', u'software', u'analysis software']),
    ...
    SoftwareName(u'Genespring MS', u'MS:1000684', u'Software for quantitation and statistical analysis of TOF and Q-TOF LC/MS data.',
                 'software', [u'Agilent software', u'analysis software', u'data processing software', u'software']),
    SoftwareName(u'MassHunter BioConfirm', u'MS:1000683', u'Software for protein characterization.',
                 'software', [u'Agilent software', u'analysis software', u'data processing software', u'software']),
    SoftwareName(u'MassHunter Metabolite ID', u'MS:1000682', u'Software for identification of metabolites.',
                 'software', [u'Agilent software', u'analysis software', u'data processing software', u'software']),
    ...
    SoftwareName(u'mzR', u'MS:1002869', u'Bioconductor package mzR for reading and writing mass spectrometry data files.',
                 'software', [u'analysis software', u'data processing software', u'software']),
    SoftwareName(u'LOBSTAHS', u'MS:1002979', u'Adduct-Based lipidomics software for the discovery and identification of oxidative stress biomarkers.',
                 'software', [u'lipidomics analysis software', u'data processing software', u'small molecule analysis software', u'software', u'analysis software']),
    SoftwareName(u'LIMSA', u'MS:1002978', u'Software tool for the quantitative analysis of mass spectrometric lipidome data.',       'software', [
                 u'lipidomics analysis software', u'data processing software', u'small molecule analysis software', u'software', u'analysis software']),
    SoftwareName(u'LipiDex', u'MS:1002974', u'An integrated software package for high-confidence lipid identification.',       'software',
                 [u'lipidomics analysis software', u'data processing software', u'small molecule analysis software', u'software', u'analysis software']),
    ...
    SoftwareName(u'ProteinLynx Global Server', u'MS:1000601', u'Waters software for data analysis.',
                 'software', [u'Waters software', u'analysis software', u'data processing software', u'software']),
    SoftwareName(u'Proteios', u'MS:1000600', u'Database application and analysis platform for proteomics." [PSI:MS',       'software', [
                 u'analysis software', u'data processing software', u'software']),
    SoftwareName(u'LIQUID', u'MS:1002975', u'An-open source software for identifying lipids in LC-MS/MS-based lipidomics data.',       'software',
                 [u'lipidomics analysis software', u'data processing software', u'small molecule analysis software', u'software', u'analysis software']),
    ...
    SoftwareName(u'Amanda', u'MS:1002336', u'Amanda scoring system for PSM identification.',
                 'software', [u'analysis software', u'software']),
    SoftwareName(u'TopFD', u'MS:1002902', u'Top-down mass spectral feature detection.',
                 'software', [u'analysis software', u'software']),
    ...
    SoftwareName(u'TopMG', u'MS:1002903',
                 u'A mass graph-based approach for the identification of modified proteoforms using top-down tandem mass spectra." [PMID:28453668',       'software', [u'analysis software', u'software']),
    SoftwareName(u'TopPIC', u'MS:1002901',
                 u'TopPIC: a software tool for top-down mass spectrometry-based proteoform identification and characterization." [PMID:27423895',       'software', [u'analysis software', u'software']),
    ...
    SoftwareName(u'NIST MSPepSearch', u'MS:1002750', u'Search tool of the NIST (National Institute of Standards and Technology) for spectral library searches.',
                 'software', [u'analysis software', u'software']),
    SoftwareName(u'Trans-Proteomic Pipeline', u'MS:1002285', u'A suite of open source tools for the processing of MS2 proteomics data developed by the Seattle Proteome Center at the Institute for Systems Biology.',
                 'software', [u'analysis software', u'software']),
    ...
    SoftwareName(u'MIDAS Workflow Designer', u'MS:1000673', u'Applied Biosystems|MDS SCIEX software for MRM assay development.',
                 'software', [u'SCIEX software', u'software']),
    SoftwareName(u'Compass Security Pack', u'MS:1000716', u'Bruker compass Security Pack software.',
    ...
    SoftwareName(u'ITRAQAnalyzer', u'MS:1002129', u'Software for iTRAQ workflow. Extracts and normalizes iTRAQ information from an MS experiment.',       'software', [
                 u'quantitation software name', u'TOPP software', u'software', u'quantification information', u'analysis software', u'data processing software']),
    SoftwareName(u'TOPP noise filter', u'MS:1002131', u'Noise filter component of the TOPP software.',
    ...
    SoftwareName(u'TOPP spectra filter', u'MS:1002137', u'Spectra filter component of the TOPP software.',
                 'software', [u'TOPP software', u'analysis software', u'data processing software', u'software']),
    SoftwareName(u'TOPP peak picker', u'MS:1002134', u'Peak picker component of the TOPP software.',
                 'software', [u'TOPP software', u'analysis software', u'data processing software', u'software']),
    SoftwareName(u'TOPP map aligner', u'MS:1002147', u'Map aligner component of the TOPP software.',
                 'software', [u'TOPP software', u'analysis software', u'data processing software', u'software']),
    SoftwareName(u'TOPP MassTraceExtractor', u'MS:1002159', u'Annotates mass traces in centroided LC/MS maps.',
                 'software', [u'TOPP software', u'analysis software', u'data processing software', u'software']),
    SoftwareName(u'TOPP MzTabExporter', u'MS:1002158', u'Exports various XML formats to an mzTab file.',
                 'software', [u'TOPP software', u'analysis software', u'data processing software', u'software']),
    ...
    SoftwareName(u'TOPP SpectraMerger', u'MS:1002157', u'Merges spectra from an LC/MS map, either by precursor or by RT blocks.',
                 'software', [u'TOPP software', u'analysis software', u'data processing software', u'software']),
    SoftwareName(u'TOPP IDFileConverter', u'MS:1002156', u'Converts identification engine file formats.',
                 'software', [u'TOPP software', u'analysis software', u'data processing software', u'software']),
    ...
    SoftwareName(u'DBImporter', u'MS:1000755', u'Imports data to an OpenMS database.',       'software', [
                 u'TOPP software', u'analysis software', u'data processing software', u'software']),
    SoftwareName(u'DBExporter', u'MS:1000754', u'Exports data from an OpenMS database to a file.',
                 'software', [u'TOPP software', u'analysis software', u'data processing software', u'software']),
    SoftwareName(u'FileFilter', u'MS:1000757', u'Extracts or manipulates portions of data from peak, feature or consensus feature files.',
                 'software', [u'TOPP software', u'analysis software', u'data processing software', u'software']),
    SoftwareName(u'FileConverter', u'MS:1000756', u'Converts between different MS file formats.',
                 'software', [u'TOPP software', u'analysis software', u'data processing software', u'software']),
    ...
    SoftwareName(u'ProteoWizard msconvert', u'MS:1002205', u'Converts, filters, and processes mass spectrometry data in variety of formats.',
                 'software', [u'ProteoWizard software', u'analysis software', u'data processing software', u'software']),
    SoftwareName(u'ProteoWizard chainsaw', u'MS:1002207', u'Filters and processes protein sequence databases.',
                 'software', [u'ProteoWizard software', u'analysis software', u'data processing software', u'software']),
    ...
    SoftwareName(u'mzidLib:Thresholder', u'MS:1002242', u'A routine for keeping only identifications passing a given threshold or setting passThreshold to true or false for SpectrumIdentificationItem or ProteinDetectionHypothesis in mzIdentML files.',
                 'software', [u'mzidLib', u'analysis software', u'software']),
    SoftwareName(u'lipidomics analysis software', u'MS:1002964', u'Lipidomics analysis software.',
    ...
    SoftwareName(u'Compound Discoverer', u'MS:1002880', u'Metabolomics analysis software from Thermo Fisher Scientific.',
                 'software', [u'small molecule analysis software', u'analysis software', u'software']),
    SoftwareName(u'TopPIC:proteoform-level FDR', u'MS:1002930', u'TopPIC proteoform-level FDR.',       'software', [u'proteoform-level local FDR', u'search engine specific score for proteoforms',
                                                                                                                    u'proteoform-level identification statistic', u'proteoform-level identification attribute', u'single identification result attribute', u'identification attribute', u'analysis attribute', u'spectrum identification result details']),
    SoftwareName(u'TopMG:proteoform-level FDR', u'MS:1002952', u'TopMG proteoform-level FDR.',       'software', [u'proteoform-level local FDR', u'search engine specific score for proteoforms', u'proteoform-level identification statistic',
                                                                                                                  u'proteoform-level identification attribute', u'single identification result attribute', u'identification attribute', u'analysis attribute', u'spectrum identification result details']),
    ...
    SoftwareName(u'TOPP FeatureLinkerLabeled', u'MS:1002175', u'Groups corresponding isotope-labeled features in a feature map.',
                 'software', [u'TOPP feature linker', u'TOPP software', u'analysis software', u'data processing software', u'software']),
    SoftwareName(u'TOPP OpenSwathFeatureXMLToTSV', u'MS:1002201', u'Converts a featureXML to a mProphet tsv (tab separated values).',
