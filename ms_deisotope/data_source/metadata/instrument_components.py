...
ionization_types = [
    ...
    Component(u'fast ion bombardment', u'MS:1000446', u'The ionization of any species by the interaction of a focused beam of ions having a translational energy of several thousand eV with a solid sample.',
    ...
    Component(u'flowing afterglow', u'MS:1000255', u'An ion source immersed in a flow of helium or other inert buffer gas that carries the ions through a meter-long reactor at pressures around 100 Pa.',
              'ionization type', [u'ionization type']),
    ...
    Component(u'spark ionization', u'MS:1000404', u'The formation of ions from a solid material by an intermittent electrical discharge.',
              'ionization type', [u'ionization type']),
    Component(u'thermal ionization', u'MS:1000407', u'The ionization of a neutral species through contact with a high temperature surface.',
              'ionization type', [u'ionization type']),
    Component(u'surface ionization', u'MS:1000406', u'The ionization of a neutral species when it interacts with a solid surface with an appropriate work function and temperature.',
              'ionization type', [u'ionization type']),
    ...
    Component(u'soft ionization', u'MS:1000403', u'The formation of gas-phase ions without extensive fragmentation.',
              'ionization type', [u'ionization type']),
    Component(u'secondary ionization', u'MS:1000402', u'The process in which ions are ejected from a sample surface as a result of bombardment by a primary beam of atoms or ions.',
              'ionization type', [u'ionization type']),
    Component(u'vertical ionization', u'MS:1000408', u'A process in which an electron is removed from or added to a molecule without a change in the positions of the atoms. The resulting ion is typically in an excited vibrational state.',
              'ionization type', [u'ionization type']),
    Component(u'autodetachment', u'MS:1000383', u'The formation of a neutral when a negative ion in a discrete state with an energy greater than the detachment threshold loses an electron spontaneously without further interaction with an energy source.',
              'ionization type', [u'ionization type']),
    Component(u'adiabatic ionization', u'MS:1000380', u'A process whereby an electron is removed from an atom, ion, or molecule to produce an ion in its lowest energy state.',
              'ionization type', [u'ionization type']),
    ...
    Component(u'chemi-ionization', u'MS:1000386', u'The reaction of a neutral molecule with an internally excited molecule to form an ion. Note that this term is not synonymous with chemical ionization.',
              'ionization type', [u'ionization type']),
    ...
    Component(u'electron ionization', u'MS:1000389', u"The ionization of an atom or molecule by electrons that are typically accelerated to energies between 50 and 150 eV. Usually 70 eV electrons are used to produce positive ions. The term 'electron impact' is not recommended.",
              'ionization type', [u'ionization type']),
    Component(u'field ionization', u'MS:1000258', u'The removal of electrons from any species by interaction with a high electric field.',
              'ionization type', [u'ionization type']),
    ...
    Component(u'penning ionization', u'MS:1000399', u'Ionization that occurs through the interaction of two or more neutral gaseous species, at least one of which is internally excited.',
              'ionization type', [u'ionization type']),
    ...
    Component(u'nanoelectrospray', u'MS:1000398', u'Electrospray ionization at a flow rate less than ~25 nL/min. Nanoelectrospray is synonymous with nanospray. The flow is dependent on the potenial on the tip of the electrospray needle and/or a gas presure to push the sample through the needle. See also electrospray ionization and microelectrospray.',
              'ionization type', [u'electrospray ionization', u'ionization type']),
    Component(u'matrix-assisted laser desorption ionization', u'MS:1000075', u'The formation of gas-phase ions from molecules that are present in a solid or solvent matrix that is irradiated with a pulsed laser. See also laser desorption/ionization.',
    ...
    Component(u'field desorption', u'MS:1000257', u'The formation of gas-phase ions from a material deposited on a solid surface in the presence of a high electric field. Because this process may encompass ionization by field ionization or other mechanisms, it is not recommended as a synonym for field desorption ionization.',
              'ionization type', [u'desorption ionization', u'ionization type']),
    Component(u'surface-assisted laser desorption ionization', u'MS:1000405', u'The formation of gas-phase ions from molecules that are deposited on a particular surface substrate that is irradiated with a pulsed laser. See also matrix-assisted laser desorption ionization.',
              'ionization type', [u'desorption ionization', u'ionization type']),
...
detector_types = [
    ...
    Component(u'photomultiplier', u'MS:1000116', u'A detector for conversion of the ion/electron signal into photon(s) which are then amplified and detected.',
              'detector type', [u'detector type']),
    Component(u'multi-collector', u'MS:1000115', u'A detector system commonly used in inductively coupled plasma mass spectrometers.',
              'detector type', [u'detector type']),
    ...
    Component(u'dynode', u'MS:1000347', u'One of a series of electrodes in a photomultiplier tube. Such an arrangement is able to amplify the current emitted by the photocathode.',
              'detector type', [u'detector type']),
    Component(u'array detector', u'MS:1000345', u'Detector comprising several ion collection elements, arranged in a line or grid where each element is an individual detector.',
              'detector type', [u'detector type']),
    ...
    Component(u'point collector', u'MS:1000350', u'A detector in which the ion beam is focused onto a point and the individual ions arrive sequentially.',
              'detector type', [u'detector type']),
    ...
    Component(u'conversion dynode electron multiplier', u'MS:1000108', u'A surface that is held at high potential so that ions striking the surface produce electrons that are subsequently detected.',
...
inlet_types = [
    ...
    Component(u'reservoir', u'MS:1000067', u'A sample inlet method involving a reservoir.',
              'inlet type', [u'inlet type']),
    Component(u'particle beam', u'MS:1000066',
              u'Method for generating ions from a solution of an analyte.',       'inlet type', [u'inlet type']),
    Component(u'open split', u'MS:1000065', u'A division of flowing stream of liquid into two streams.',
              'inlet type', [u'inlet type']),
    ...
    Component(u'infusion', u'MS:1000060', u'The continuous flow of solution of a sample into the ionization source.',
              'inlet type', [u'inlet type']),
    ...
    Component(u'septum', u'MS:1000068', u'A disc composed of a flexible material that seals the entrance to the reservoir. Can also be entrance to the vacuum chamber.',
              'inlet type', [u'inlet type']),
