...
dissociation_methods = [
        ...
        DissociationMethod(u'post-source decay',
                           u'MS:1000135',
                           u'A technique specific to reflectron time-of-flight mass spectrometers where product ions of metastable transitions or collision-induced dissociations generated in the drift tube prior to entering the reflectron are m/z separated to yield product ion spectra.',
                           'dissociation method', [u'dissociation method']),
        DissociationMethod(u'plasma desorption', u'MS:1000134',
                           u'The ionization of material in a solid sample by bombarding it with ionic or neutral atoms formed as a result of the fission of a suitable nuclide, typically 252Cf. Synonymous with fission fragment ionization.',
                           'dissociation method', [u'dissociation method']),
        DissociationMethod(u'surface-induced dissociation', u'MS:1000136',
                           u'Fragmentation that results from the collision of an ion with a surface.',
                           'dissociation method', [u'dissociation method']),
        ...
        DissociationMethod(u'pulsed q dissociation', u'MS:1000599',
                           u'A process that involves precursor ion activation at high Q, a time delay to allow the precursor to fragment, then a rapid pulse to low Q where all fragment ions are trapped. The product ions can then be scanned out of the ion trap and detected.', 'dissociation method', [u'dissociation method']),
        ...
        DissociationMethod(u'photodissociation', u'MS:1000435', u'A process wherein the reactant ion is dissociated as a result of absorption of one or more photons.',
                           'dissociation method', [u'dissociation method']),
        DissociationMethod(
            u'LIFT', u'MS:1002000', u'A Bruker\'s proprietary technique where molecular ions are initially accelerated at lower energy, then collide with inert gas in a collision cell that is then \'lifted\' to high potential. The use of inert gas is optional, as it could lift also fragments provided by LID." [DOI:10.1007/s00216-003-2057-0 ', 'dissociation method', [u'dissociation method']),
